...
static void	test_memcmp_child1(void) {
	...
	tlib_testresult_bool(ft_memcmp("ASDFG", "ASFFG", 5));
	tlib_testresult_bool(!ft_memcmp("ASDFG", "ASDFH", 4));
	tlib_testresult_bool(!ft_memcmp("ASDFG", "ASD", 3));
	tlib_testresult_bool(!ft_memcmp("ASD", "ASDFG", 3));
	tlib_testresult_bool(ft_memcmp("ASD\0G", "ASD\0H", 5));
...
static void	test_memcmp_child2(void) {
	...
	tlib_testresult_bool(!ft_memcmp(NULL, NULL, 0));
	tlib_testmalloc_count(0);
}
