...
static void	test_strncmp_testequal(char *s1, char *s2, size_t n) {
	...
	tlib_testmalloc_leak("ft_strncmp(%S, %S, %z)", s1, s2, n);
}
...
void	test_strncmp(void) {
	...
	tlib_testprocess_segfault(&test_strncmp_child3, "ft_strncmp(\"HOLA\", NULL, 5)");
	tlib_testprocess_segfault(&test_strncmp_child4, "ft_strncmp(NULL, \"HOLA\", 5)");
}
