...
static void	test_strjoin_child2(void) {
	...
	tlib_testmalloc_leak("ft_strjoin(\"HOLA\", \" MUNDO\") (with malloc fail)");
}

static void	test_strjoin_child3(void) {
	tlib_testresult_addr(ft_strjoin(NULL, " MUNDO"), NULL, "ft_strjoin(NULL, \" MUNDO\")");
	tlib_testmalloc_leak("ft_strjoin(NULL, \" MUNDO\")");
}

static void	test_strjoin_child4(void) {
	tlib_testresult_addr(ft_strjoin("HOLA", NULL), NULL, "ft_strjoin(\"HOLA\", NULL)");
	tlib_testmalloc_leak("ft_strjoin(\"HOLA\", NULL)");
}

static void	test_strjoin_child5(void) {
	tlib_testresult_addr(ft_strjoin(NULL, NULL), NULL, "ft_strjoin(NULL, NULL)");
	tlib_testmalloc_leak("ft_strjoin(NULL, NULL)");
}
...
void	test_strjoin(void) {
	...
	tlib_testprocess_ok(&test_strjoin_child5, "ft_strjoin(NULL, NULL)");
}
