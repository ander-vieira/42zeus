...
void	test_lstiter(void) {
	tlib_testprocess_ok(&test_lstiter_child1, NULL);
	tlib_testprocess_ok(&test_lstiter_child2, NULL);
	tlib_testprocess_ok(&test_lstiter_child3, NULL);
	tlib_testprocess_ok(&test_lstiter_child4, NULL);
}
